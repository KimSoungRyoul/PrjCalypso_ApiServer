...
public class MemberMapperTest extends DefaultAbstractTest {
  ...
  public void selectMember() {
    ...
    MemberAccount memberAccount2 = memberMapper.selectMember("rlatjduf510@naver.com");
  ...
  public void selectVolunteerInfo() {
    ...
    VolunteerMemberInfo volunteerMemberInfo =
        memberMapper.selectPersonalVolunteerInfo("sky5367@gmail.com");
  ...
  public void selectCompanyVolunteerInfo() {
    ...
    VolunteerMemberInfo volunteerMemberInfo =
        memberMapper.selectCompanyVolunteerInfo("rlatjduf510@naver.com");
  ...
  public void selectMAdminInfo() {
    ...
    TheMarginalizedAdminMemberInfo mAdminInfo = memberMapper
        .selectMAdminInfo("arachne0823@gmail.com");
