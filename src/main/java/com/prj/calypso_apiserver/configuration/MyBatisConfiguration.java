package com.prj.calypso_apiserver.configuration;
...
@MapperScan(value = "com.prj.calypso_apiserver.persistence")//DAO Mapper Setting
public class MyBatisConfiguration {
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource)throws Exception{
        ...
        //sessionFactory.setEnvironment("unitTest");
        sessionFactory.setMapperLocations(res);
        sessionFactory.setTypeAliasesPackage("com.prj.calpyso_apiserver.domain");
